...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { code: @coupon.code, discount_value: @coupon.discount_value, fix_discount: @coupon.fix_discount, string: @coupon.string, unique: @coupon.unique, user_id: @coupon.user_id } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { code: @coupon.code, discount_value: @coupon.discount_value, fix_discount: @coupon.fix_discount, string: @coupon.string, unique: @coupon.unique, user_id: @coupon.user_id } }
