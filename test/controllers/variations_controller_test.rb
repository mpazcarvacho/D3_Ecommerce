...
class VariationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variation" do
    assert_difference('Variation.count') do
      post variations_url, params: { variation: { color_id: @variation.color_id, product_id: @variation.product_id, size_id: @variation.size_id, stock: @variation.stock } }
    end
  ...
  test "should update variation" do
    patch variation_url(@variation), params: { variation: { color_id: @variation.color_id, product_id: @variation.product_id, size_id: @variation.size_id, stock: @variation.stock } }
